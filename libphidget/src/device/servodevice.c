...
// === Internal Functions === //=
static PhidgetReturnCode _sendpacket(PhidgetServoDeviceHandle phid, int Index);
...
_sendpacket(PhidgetServoDeviceHandle phid, int Index) {
