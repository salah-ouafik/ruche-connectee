...
PhidgetReturnCode PhidgetHubDevice_setPortMode(PhidgetHubDeviceHandle phid, int index, PhidgetHub_PortMode mode);
PhidgetReturnCode PhidgetHubDevice_sendpacket(PhidgetHubDeviceHandle phid, const uint8_t *buf);
