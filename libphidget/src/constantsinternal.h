...
#define PHIDGET_NETATTACHQUEUE_FLAG		0x00002000	/* Phidget is in the net attach queue */
#define PHIDGET_NETDETACHQUEUE_FLAG		0x00004000	/* Phidget is in the net detach queue */
